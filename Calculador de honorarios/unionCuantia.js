...
// Para ingresar otro valor sin necesidad de borrarlo manualmente
...
// Cuando cambia el tipo de cuantía, se limpian los valores de los campos
document.getElementById("cuantia").addEventListener("change", function() {
    document.getElementById("monto").value = "";
    document.getElementById("pretensiones").value = "";
});

// Resetear dinámicamente el campo y ocultar los resultados
document.getElementById("monto").addEventListener("input", function() {
